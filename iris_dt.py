...
"""
Example code of using the IRIS dataset with numpy to train a Decision Tree classifier. 
...
import os
os.environ["PATH"] += os.pathsep + 'C:/Users/anton/PycharmProjects/untitled/venv/Lib/site-packages/graphviz-2.38/release/bin/'
# constants
# try 1 - 5 - 7 . What changes and why? 
seed = 7

# load the dataset from csv file
with open('C:/Users/anton/Desktop/MSc/MachineLearning/tree/IRIS.csv') as f:
